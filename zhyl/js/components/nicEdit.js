...
var editlang={
    en:{
        title: {
            ...
            'save': 'Save this content',

            'imagetitle': 'Add/Edit Imag',
            'src': 'URL',
            'alt': 'Alt Text',
            'align': 'Align',
            ...
            'alignleft': 'Left',
            'alignright': 'Right',
            'imgerror': 'You must enter a Image URL to insert',
            ...
            'linkerror': 'You must enter a URL to Create a Link'
        },
        'fontfamily':
        {
...
var nicEditorConfig = bkClass.extend({
    buttons: {
        'bold': {
            name: __(currentlang.title.bold),
            command: 'Bold',
            tags: ['B', 'STRONG'],
            css: {
                'font-weight': 'bold'
        ...
        'italic': {
            name: __(currentlang.title.italic),
            command: 'Italic',
            tags: ['EM', 'I'],
            css: {
                'font-style': 'italic'
        ...
        'underline': {
            name: __(currentlang.title.underline),
            command: 'Underline',
            tags: ['U'],
            css: {
        ...
        'left': {
            name: __(currentlang.title.left),
            command: 'justifyleft',
            noActive: true
        },
        'center': {
            name: __(currentlang.title.center),
            command: 'justifycenter',
            noActive: true
        },
        'right': {
            name: __(currentlang.title.right),
            command: 'justifyright',
            noActive: true
        },
        'justify': {
            name: __(currentlang.title.justify),
            command: 'justifyfull',
            noActive: true
        },
        'ol': {
            name: __(currentlang.title.ol),
            command: 'insertorderedlist',
            tags: ['OL']
        },
        'ul': {
            name: __(currentlang.title.ul),
            command: 'insertunorderedlist',
            tags: ['UL']
        },
        'subscript': {
            name: __(currentlang.title.subscript),
            command: 'subscript',
            tags: ['SUB']
        },
        'superscript': {
            name: __(currentlang.title.superscript),
            command: 'superscript',
            tags: ['SUP']
        },
        'strikethrough': {
            name: __(currentlang.title.strikethrough),
        ...
        'removeformat': {
            name: __(currentlang.title.removeformat),
            command: 'removeformat',
            noActive: true
        },
        'indent': {
            name: __(currentlang.title.indent),
            command: 'indent',
            noActive: true
        },
        'outdent': {
            name: __(currentlang.title.outdent),
            command: 'outdent',
            noActive: true
        },
        'hr': {
            name: __(currentlang.title.hr),
            command: 'insertHorizontalRule',
            noActive: true
        }
    },
    iconsPath: '../../js/components/nicEditorIcons.gif',
...
var nicSelectOptions = {
    buttons: {
        'fontSize': {
            name: __(currentlang.title.fontSize),
            type: 'nicEditorFontSizeSelect',
            command: 'fontsize'
        },
        'fontFamily': {
            name: __(currentlang.title.fontFamily),
            type: 'nicEditorFontFamilySelect',
            command: 'fontname'
        },
        'fontFormat': {
            name: __(currentlang.title.fontFormat),
...
var nicLinkOptions = {
    buttons: {
        'link': {
            name: currentlang.title.link,
            type: 'nicLinkButton',
            tags: ['A']
        },
        'unlink': {
            name: currentlang.title.unlink,
            command: 'unlink',
            noActive: true
        }
    }
...
var nicLinkButton = nicEditorAdvancedButton.extend({
    addPane: function() {
        ...
        this.addForm({
            "": {
                type: "title",
                txt: currentlang.title.linktitle
            },
            href: {
                type: "text",
                txt: currentlang.title.href,
                value: "http://",
                style: {
                    width: "150px"
                }
            ...
            title: {
                type: "text",
                txt: currentlang.title.title
            },
            target: {
                type: "select",
                txt: currentlang.title.target,
                options: {
                    "": currentlang.title.currentwindow,
                    _blank: currentlang.title.newwindow
                },
                style: {
                    width: "100px"
                }
    ...
    submit: function(C) {
        ...
        if (A == "http://" || A == "") {
            alert(currentlang.title.linkerror);
            return false
        }
        this.removePane();
        if (!this.ln) {
            var B = A;//"javascript:nicTemp();";
...
var nicColorOptions = {
    buttons: {
        'forecolor': {
            name: __(currentlang.title.forecolor),
            type: 'nicEditorColorButton',
            noClose: true
        },
        'bgcolor': {
            name: __(currentlang.title.bgcolor),
...
var nicImageButton = nicEditorAdvancedButton.extend({
    addPane: function() {
        ...
        this.addForm({
            "": {
                type: "title",
                txt: currentlang.title.imagetitle
            },
            src: {
                type: "text",
                txt:currentlang.title.src,
                value: "http://",
                style: {
                    width: "150px"
                }
            ...
            align: {
                type: "select",
                txt: currentlang.title.align,
                options: {
                    none: currentlang.title.aligndefault,
                    left: currentlang.title.alignleft,
                    right:currentlang.title.alignright
                }
            }
        }, this.im)
    },
    submit: function(B) {
        ...
        if (C == "" || C == "http://") {
            alert(currentlang.title.imgerror);
            return false
        }
        this.removePane();
        if (!this.im) {
...
var nicSaveOptions = {
    buttons: {
        'save': {
            name: __(currentlang.title.save),
